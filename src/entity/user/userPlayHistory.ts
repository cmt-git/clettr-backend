import {Entity, PrimaryGeneratedColumn, Column, BaseEntity, CreateDateColumn, OneToOne, JoinColumn, ManyToOne} from "typeorm";
...
export class userPlayHistory extends BaseEntity {
    ...
    @ManyToOne(() => userEntity, user_entity => user_entity.bsc_address, {onDelete: 'CASCADE'})
